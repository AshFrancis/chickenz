...
export class WasmState {
     ...
     */
    clone_state() {
        const ret = wasm.wasmstate_clone_state(this.__wbg_ptr);
     ...
     */
    export_state() {
        const ret = wasm.wasmstate_export_state(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    import_state(state) {
        wasm.wasmstate_import_state(this.__wbg_ptr, state);
    }
    /**
     * @returns {boolean}
     */
    match_over() {
        const ret = wasm.wasmstate_match_over(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     * @returns {WasmState}
     */
    static new_arena(seed) {
        const ret = wasm.wasmstate_new_arena(seed);
        return WasmState.__wrap(ret);
    }
    /**
     ...
     * @returns {WasmState}
     */
    static new_warmup(seed, map_json) {
        const ptr0 = passStringToWasm0(map_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmstate_new_warmup(seed, ptr0, len0);
        return WasmState.__wrap(ret);
    }
    /**
     * @returns {number}
     */
    rng_state() {
        const ret = wasm.wasmstate_rng_state(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @param {number} p1_ay
     */
    step(p0_btn, p0_ax, p0_ay, p1_btn, p1_ax, p1_ay) {
        wasm.wasmstate_step(this.__wbg_ptr, p0_btn, p0_ax, p0_ay, p1_btn, p1_ax, p1_ay);
    }
    /**
     * @returns {number}
     */
    tick() {
        const ret = wasm.wasmstate_tick(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    winner() {
        const ret = wasm.wasmstate_winner(this.__wbg_ptr);
        return ret;
    }
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_stringify_082ac9b517dcac02: function() { return handleError(function (arg0) {
